...
public class PipelineRedirectionCombinationsTest {
    ...
    public void setUp() throws IOException {
        ...
        // Create ls_file.txt with sample filenames (one per line)
        lsFile = trackFile("ls_file.txt");
    ...
    public void test1_InputRedirectionIntoPipeline_CatWc() throws Exception {
        // Test: cat < ls_file.txt | wc -l
        // Meaning: cat reads from ls_file.txt, output goes to wc, wc counts lines
        
        System.out.println("\n=== Test 1: cat < ls_file.txt | wc -l ===");
        ...
        try {
            Command cmd = Parser.parse("cat < ls_file.txt | wc -l");
            ...
            assertEquals("ls_file.txt", catCmd.getStdInFile());
            
            System.out.println("✅ Parsing works: cat < ls_file.txt | wc -l");
    ...
    public void test2_InputRedirectionIntoPipeline_GrepWc() throws Exception {
        // Test: grep src < ls_file.txt | wc -l
        // Meaning: grep reads from file, wc counts matches
        
        System.out.println("\n=== Test 2: grep src < ls_file.txt | wc -l ===");
        
        try {
            Command cmd = Parser.parse("grep src < ls_file.txt | wc -l");
            ...
            if (first instanceof RedirectionCommand) {
                ...
                assertEquals("ls_file.txt", grepCmd.getStdInFile());
                System.out.println("✅ Parsing works: grep src < ls_file.txt | wc -l");
            }
    ...
    public void test3_PipelineWithOutputRedirection_CatWc() throws Exception {
        // Test: cat ls_file.txt | wc -l > count.txt
        // Meaning: Pipeline runs normally, final output goes to count.txt
        
        System.out.println("\n=== Test 3: cat ls_file.txt | wc -l > count.txt ===");
        
        File countFile = trackFile("count.txt");
        
        Command cmd = Parser.parse("cat ls_file.txt | wc -l > count.txt");
        assertEquals(CommandType.PIPELINE, cmd.getType());
        ...
        System.out.println("✅ Parsing works: cat ls_file.txt | wc -l > count.txt");
    ...
    public void test4_PipelineWithOutputRedirection_CatGrep() throws Exception {
        // Test: cat ls_file.txt | grep src > src_files.txt
        // Meaning: Filter happens via pipe, output redirected to file
        
        System.out.println("\n=== Test 4: cat ls_file.txt | grep src > src_files.txt ===");
        
        File srcFiles = trackFile("src_files.txt");
        
        Command cmd = Parser.parse("cat ls_file.txt | grep src > src_files.txt");
        assertEquals(CommandType.PIPELINE, cmd.getType());
        ...
        System.out.println("✅ Parsing works: cat ls_file.txt | grep src > src_files.txt");
    }
    ...
    public void test5_FullChain_InputPipelineOutput() throws Exception {
        // Test: cat < ls_file.txt | grep src | wc -l > src_count.txt
        // Meaning: ls_file.txt → cat → grep → wc → src_count.txt
        
        System.out.println("\n=== Test 5: cat < ls_file.txt | grep src | wc -l > src_count.txt ===");
        
        File srcCount = trackFile("src_count.txt");
        
        Command cmd = Parser.parse("cat < ls_file.txt | grep src | wc -l > src_count.txt");
        assertEquals(CommandType.PIPELINE, cmd.getType());
        ...
        System.out.println("   Flow: ls_file.txt → cat → grep → wc → src_count.txt");
    }
    ...
    public void test6_PipelineWithAppend() throws Exception {
        // Test: cat ls_file.txt | wc -l >> counts.log
        // Run it twice, counts.log should have two entries
        
        System.out.println("\n=== Test 6: cat ls_file.txt | wc -l >> counts.log (twice) ===");
        
        File countsLog = trackFile("counts.log");
        
        Command cmd = Parser.parse("cat ls_file.txt | wc -l >> counts.log");
        assertEquals(CommandType.PIPELINE, cmd.getType());
        ...
        System.out.println("✅ Parsing works: cat ls_file.txt | wc -l >> counts.log");
    ...
    public void test8_PipelineWithStderrRedirection_NoError() throws Exception {
        // Test: grep foo ls_file.txt | wc -l 2> err.txt
        // Expected: err.txt empty or small, output printed
        
        System.out.println("\n=== Test 8: grep foo ls_file.txt | wc -l 2> err.txt ===");
        
        File errFile = trackFile("err.txt");
        
        Command cmd = Parser.parse("grep foo ls_file.txt | wc -l 2> err.txt");
        assertEquals(CommandType.PIPELINE, cmd.getType());
        
        PipelineCommand pipeline = (PipelineCommand) cmd;
        assertEquals(2, pipeline.getCommands().size());
        
        System.out.println("✅ Parsing works: grep foo ls_file.txt | wc -l 2> err.txt");
    }
    ...
    public void test9_RedirectionBelongsToCorrectCommand() throws Exception {
        // Test: grep src < ls_file.txt | wc -l > out.txt
        // Meaning: < applies to grep, > applies to wc
        
        System.out.println("\n=== Test 9: grep src < ls_file.txt | wc -l > out.txt ===");
        
        File outFile = trackFile("out.txt");
        
        Command cmd = Parser.parse("grep src < ls_file.txt | wc -l > out.txt");
        assertEquals(CommandType.PIPELINE, cmd.getType());
        ...
        if (first instanceof RedirectionCommand) {
            ...
            System.out.println("   ✓ First command (grep): has < ls_file.txt");
        }
        ...
        System.out.println("   Flow: ls_file.txt → grep → wc → out.txt");
    }
    ...
    public void testInvalid1_PipeToOperatorOnly() {
        // Invalid: cat ls_file.txt | >
        System.out.println("\n=== Invalid Test 1: cat ls_file.txt | > ===");
        Parser.parse("cat ls_file.txt | >");
    ...
    public void testInvalid4_InputOperatorWithPipeStart() {
        // Invalid: < ls_file.txt | wc
        System.out.println("\n=== Invalid Test 4: < ls_file.txt | wc ===");
        Parser.parse("< ls_file.txt | wc");
